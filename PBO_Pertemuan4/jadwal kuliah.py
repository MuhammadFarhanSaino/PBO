...
def tambah_jadwal():
    ...
    dosen_pengampu = entry_dosen_pengampu.get()

    # Menambahkan data ke dalam treeview
    tree.insert("", "end", values=(mata_kuliah, ruang, hari, jam_mulai, jam_selesai, dosen_pengampu))
    ...
    entry_dosen_pengampu.delete(0, "end")
...
label_dosen_pengampu = tk.Label(window, text="Dosen Pengampu:")
entry_dosen_pengampu = tk.Entry(window)
...
label_dosen_pengampu.grid(row=5, column=0, padx=10, pady=5)
entry_dosen_pengampu.grid(row=5, column=1, padx=10, pady=5)
