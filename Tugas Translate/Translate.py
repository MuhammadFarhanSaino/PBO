...
class FrmTranslator:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Inggris:').grid(row=2, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Italian:').grid(row=3, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Javanese:').grid(row=4, column=0,
            sticky=W, padx=5, pady=5)
        # pasang textbox
    ...
    def onTranslate(self):
        ...
        hasil3 = penterjemah.translate(self.txtSumber.get(), src='id', dest='jw') 
